...
<body>
    <div class="row" style="height: 100vh; display: grid; place-items:center;">
            ...
            <div class="row text-center mt-1">
                <p><small>Sudah Punya Akun? <a href="index.php" class="text-decoration-none">Login Now!</a>Atau Daftar Sebagai Seller <a href="daftar_seler.php" class="text-decoration-none">Daftar!</a></small></p>
            </div>
            </div>
    </div>
...
if(isset($_POST['register'])){
	...
	$simpan = mysqli_query($koneksi, "INSERT INTO user (nama,email,password,role) VALUES ('$nama','$email', '$password_acak','$level')");
    if($simpan){
        echo "<script>
