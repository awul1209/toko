...
function sendMessage() {
    ...
    <script>
        ...
        function sendMessage() {
            ...
            formData.append('pengirim_tipe', 'user');
            formData.append('penerima_tipe', 'seller');
        ...
        function loadMessages() {
            fetch(`ambil_pesan.php?user_id=<?php echo $user_id; ?>&seller_id=<?php echo $seller_id; ?>`)
